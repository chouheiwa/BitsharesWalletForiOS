...
- (NSData *)transformToData {
    ...
    [data appendData:[PackData packInt:self.weight_threshold]];
    
    [data appendData:[PackData packUnsigedInteger:self.account_auths.count]];
    
    for (id <ObjectToDataProtocol>obj in self.account_auths) {
        [data appendData:[obj transformToData]];
    }
    
    [data appendData:[PackData packUnsigedInteger:self.key_auths.count]];
    
    for (id <ObjectToDataProtocol>obj in self.key_auths) {
        [data appendData:[obj transformToData]];
    }
    
    [data appendData:[PackData packUnsigedInteger:self.address_auths.count]];
