...
- (void)testPlainKey {
    PlainKey *plainKey = [[PlainKey alloc] initWithCipherKey:@""];
    
    PrivateKey *priKey = [[PrivateKey alloc] initWithPrivateKey:@"5JzhaUrXLTrAXmFqEF1AMnNJN9oCPgJN66NLHb2rZ9d8VQaeQiQ"];
